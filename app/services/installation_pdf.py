...
def generate_installation_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title=f"SK-POS Care Installation — {installation.reference}",
        author="SK-POS Care",
    )
    ...
    story.append(Paragraph("SK-POS Care Installation Record", h_style))
    ...
    story.append(Paragraph(
        "<font color='#737373' size='8.5'>This document is auto-generated by SK-POS Care "
