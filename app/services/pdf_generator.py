...
Composes a one-page PDF with:
  - SK-POS Care header + ticket reference
...
def generate_resolution_pdf(ticket: Ticket, resolution: Resolution) -> bytes:
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title=f"SK-POS Care Resolution — {ticket.reference}",
        author="SK-POS Care",
    )
    ...
    # ---- Header ----
    story.append(Paragraph("SK-POS Care Service Resolution", h_style))
    ...
    story.append(Paragraph(
        "<font color='#737373' size='8.5'>This document is auto-generated by SK-POS Care upon mutual acknowledgement of resolution. "
